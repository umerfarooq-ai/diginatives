...
async def analyze_skin(
    ...
    """
    Analyze skin image using AI and return comprehensive results
    """
...
async def get_skin_analysis(
    ...
    """
    Get skin analysis results by scan ID
    """
    ...
    response_data = {
        ...
        "amRoutine": skin_analysis.am_routine,
        "pmRoutine": skin_analysis.pm_routine,
...
async def get_user_skin_analysis_history(
    ...
    for analysis in analyses:
        history_data.append({
            ...
            # },
            # "amRoutine": analysis.am_routine,
            # "pmRoutine": analysis.pm_routine,
